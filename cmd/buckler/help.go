...
func ShowHelp(command string) {
	...
	case "create-job": /* {{{ */
		...
		fmt.Printf("\n")
		fmt.Printf("  --disaster-recovery   This job is used for Disaster Recovery and will be encrypted\n")
		fmt.Printf("                        using the fixed disaster key.\n")
		fmt.Printf("\n")
	...
	case "update-job": /* {{{ */
		...
		fmt.Printf("                        an operator will have to manually kick it off.\n")
		fmt.Printf("\n")
		fmt.Printf("  --disaster-recovery   [true/false] This job is used for Disaster Recovery and will be encrypted\n")
		fmt.Printf("                        using the fixed disaster key.\n")
		fmt.Printf("\n")
		fmt.Printf("  In @Y{--batch} mode, the name or UUID specified on the command-line\n")
		fmt.Printf("  must be \"unique enough\" for buckler to determine what you meant.\n")
