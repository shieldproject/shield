...
func ShowHelp(command string) {
	...
	case "create-job": /* {{{ */
		...
		fmt.Printf("\n")
		fmt.Printf("  --fixed-key   Allows the backups to be encrypted using the fixed key provided upon\n")
		fmt.Printf("                initilization. Backups of shield itself must use this option to be\n")
		fmt.Printf("                recoverable in a disaster scenario\n")
		fmt.Printf("\n")
	...
	case "rekey": /* {{{ */
		...
		fmt.Printf("\n")
		fmt.Printf("  --rotate-fixed-key  Rotate the key used for fixed-key encryption.\n")
		fmt.Printf("\n")
	...
	case "update-job": /* {{{ */
		...
		fmt.Printf("                 an operator will have to manually kick it off.\n")
		fmt.Printf("\n")
		fmt.Printf("  --fixed-key    [true/false] Allows the backups to be encrypted using\n")
		fmt.Printf("                 the fixed key provided upon initilization. Backups of shield \n")
		fmt.Printf("                 itself must use this option to be recoverable in a disaster scenario")
		fmt.Printf("\n")
		fmt.Printf("  In @Y{--batch} mode, the name or UUID specified on the command-line\n")
		fmt.Printf("  must be \"unique enough\" for buckler to determine what you meant.\n")
		fmt.Printf("  In interactive mode, you will be asked to narrow your search\n")
