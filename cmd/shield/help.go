...
func ShowHelp(command string) {
	...
	case "agent": /* {{{ */
		...
		fmt.Printf("\n")
		fmt.Printf("  Agents perform all backup / restore operations on\n")
	...
	case "bucket": /* {{{ */
		...
		fmt.Printf("\n")
		fmt.Printf("  Show a single Cloud Storage Bucket\n")
		fmt.Printf("\n")
		...
		fmt.Printf("  Cloud Storage Bucket provides the configuration details needed\n")
	...
	/* }}} */
	case "buckets": /* {{{ */
		fmt.Printf("USAGE: @G{shield} buckets [OPTIONS]\n")
		fmt.Printf("\n")
		fmt.Printf("  List Shared Cloud Storage Buckets\n")
		fmt.Printf("\n")
		fmt.Printf("  SHIELD needs a place to store all of the backup archives it is\n")
		fmt.Printf("  going to generate, and Cloud Storage is where it's at.  Each\n")
		fmt.Printf("  Cloud Storage Bucket provides the configuration details needed\n")
	...
	case "create-job": /* {{{ */
		...
		fmt.Printf("                  This field is @W{required}.\n")
		fmt.Printf("\n")
		fmt.Printf("  --bucket        The name or key of the cloud storage bucket to\n")
	...
	case "jobs": /* {{{ */
		...
		fmt.Printf("\n")
		fmt.Printf("  --bucket        Only show backup jobs for the given cloud storage\n")
		fmt.Printf("                  system (given by name or key).\n")
		fmt.Printf("\n")
	...
	case "targets": /* {{{ */
		...
		fmt.Printf("  --unused        (referenced by a job configuration) or @W{unused}.\n")
